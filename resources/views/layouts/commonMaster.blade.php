...
<head>
  ...
  <title>
    ...
    {{-- >peership|modify: The way the template suffix is displayed. If it is null, it does not display anything. --}}
  ...
  <!-- Favicon -->
  {{-- >peership|modify: Favicon. --}}
  <link rel="icon" type="image/x-icon" href="{{ asset('assets/img/peership/favicon/favicon.ico') }}" />
