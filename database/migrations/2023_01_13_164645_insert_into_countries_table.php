...
return new class extends Migration
{
    ...
    public function up()
    {
        DB::table('countries')->insert([
            ...
            ['id' => 'AI', 'name' => 'Anguilla', 'phone_code' => '+1'],
            ['id' => 'AQ', 'name' => 'Antarctica', 'phone_code' => '+672'],
            ['id' => 'AG', 'name' => 'Antigua and Barbuda', 'phone_code' => '+1'],
            ...
            ['id' => 'BM', 'name' => 'Bermuda', 'phone_code' => '+1'],
            ...
            ['id' => 'CW', 'name' => 'Curaçao', 'phone_code' => '+599'],
            ...
            ['id' => 'DM', 'name' => 'Dominica', 'phone_code' => '+1'],
            ['id' => 'DO', 'name' => 'Dominican Republic', 'phone_code' => '+1'],
            ['id' => 'CD', 'name' => 'Democratic Republic of the Congo', 'phone_code' => '+243'],
            ...
            ['id' => 'FK', 'name' => 'Falkland Islands', 'phone_code' => '+500'],
            ...
            ['id' => 'GD', 'name' => 'Grenada', 'phone_code' => '+1'],
            ['id' => 'GP', 'name' => 'Guadeloupe', 'phone_code' => '+590'],
            ['id' => 'GU', 'name' => 'Guam', 'phone_code' => '+1'],
            ['id' => 'GT', 'name' => 'Guatemala', 'phone_code' => '+502'],
            ['id' => 'GG', 'name' => 'Guernsey', 'phone_code' => '+44'],
            ...
            ['id' => 'JM', 'name' => 'Jamaica', 'phone_code' => '+1'],
            ...
            ['id' => 'MK', 'name' => 'Macedonia', 'phone_code' => '+389'],
            ...
            ['id' => 'FM', 'name' => 'Micronesia', 'phone_code' => '+691'],
            ...
            ['id' => 'MS', 'name' => 'Montserrat', 'phone_code' => '+1'],
            ...
            ['id' => 'MP', 'name' => 'Northern Mariana Islands', 'phone_code' => '+1'],
            ...
            ['id' => 'PS', 'name' => 'Palestine', 'phone_code' => '+970'],
            ...
            ['id' => 'PN', 'name' => 'Pitcairn', 'phone_code' => '+64'],
            ['id' => 'PL', 'name' => 'Poland', 'phone_code' => '+48'],
            ['id' => 'PT', 'name' => 'Portugal', 'phone_code' => '+351'],
            ['id' => 'PR', 'name' => 'Puerto Rico', 'phone_code' => '+1'],
            ['id' => 'QA', 'name' => 'Qatar', 'phone_code' => '+974'],
            ['id' => 'CG', 'name' => 'Republic of the Congo', 'phone_code' => '+242'],
            ['id' => 'RE', 'name' => 'Réunion', 'phone_code' => '+262'],
            ['id' => 'RO', 'name' => 'Romania', 'phone_code' => '+40'],
            ['id' => 'RU', 'name' => 'Russia', 'phone_code' => '+7'],
            ['id' => 'RW', 'name' => 'Rwanda', 'phone_code' => '+250'],
            ['id' => 'BL', 'name' => 'Saint Barthelemy', 'phone_code' => '+590'],
            ['id' => 'SH', 'name' => 'Saint Helena, Ascension and Tristan da Cunha', 'phone_code' => '+290'],
            ['id' => 'KN', 'name' => 'Saint Kitts and Nevis', 'phone_code' => '+1'],
            ['id' => 'LC', 'name' => 'Saint Lucia', 'phone_code' => '+1'],
            ['id' => 'MF', 'name' => 'Saint Martin', 'phone_code' => '+590'],
            ['id' => 'PM', 'name' => 'Saint Pierre and Miquelon', 'phone_code' => '+508'],
            ['id' => 'VC', 'name' => 'Saint Vincent and the Grenadines', 'phone_code' => '+1'],
            ['id' => 'WS', 'name' => 'Samoa', 'phone_code' => '+685'],
            ['id' => 'SM', 'name' => 'San Marino', 'phone_code' => '+378'],
            ['id' => 'ST', 'name' => 'Sao Tome and Principe', 'phone_code' => '+239'],
            ...
            ['id' => 'SZ', 'name' => 'Swaziland', 'phone_code' => '+268'],
            ['id' => 'SE', 'name' => 'Sweden', 'phone_code' => '+46'],
            ['id' => 'CH', 'name' => 'Switzerland', 'phone_code' => '+41'],
            ['id' => 'SY', 'name' => 'Syria', 'phone_code' => '+963'],
            ['id' => 'TW', 'name' => 'Taiwan', 'phone_code' => '+886'],
            ...
            ['id' => 'VA', 'name' => 'Vatican City', 'phone_code' => '+39'],
            ['id' => 'VU', 'name' => 'Vanuatu', 'phone_code' => '+678'],
            ['id' => 'VE', 'name' => 'Venezuela', 'phone_code' => '+58'],
            ['id' => 'VN', 'name' => 'Vietnam', 'phone_code' => '+84'],
            ['id' => 'VG', 'name' => 'Virgin Islands (British)', 'phone_code' => '+1'],
            ['id' => 'VI', 'name' => 'Virgin Islands (U.S.)', 'phone_code' => '+1'],
