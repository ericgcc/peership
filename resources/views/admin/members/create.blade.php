...
@section('vendor-style')
    ...
    <link rel="stylesheet" href="{{ asset(mix('vendors/peership/css/forms/intl-tel-input/intlTelInput.min.css')) }}">
    <link rel="stylesheet"
          href="{{ asset(mix('vendors/peership/css/forms/webui-popover/jquery.webui-popover.min.css')) }}">
@endsection
...
@section('page-style')
    ...
    <style>
        .iti__flag {
            background-image: url("{{ asset(mix('vendors/peership/css/forms/intl-tel-input/img/flags.png')) }}");
        }

        @media (-webkit-min-device-pixel-ratio: 2), (min-resolution: 192dpi) {
            .iti__flag {
                background-image: url("{{ asset(mix('vendors/peership/css/forms/intl-tel-input/img/flags@2x.png')) }}");
            }
        }
...
@section('vendor-script')
    ...
    <script src="{{ asset(mix('vendors/peership/js/forms/intl-tel-input/intlTelInput-jquery.min.js')) }}"></script>
    <script src="{{ asset(mix('vendors/peership/js/forms/intl-tel-input/utils.js')) }}"></script>
    <script src="{{ asset(mix('vendors/peership/js/forms/webui-popover/jquery.webui-popover.min.js')) }}"></script>
    <script src="{{asset(mix('vendors/peership/js/forms/dependent-dropdown/dependent-dropdown.min.js'))}}"></script>
@endsection
@section('page-script')
    <!-- Page js files -->
